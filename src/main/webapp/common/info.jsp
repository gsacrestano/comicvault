...
<p>Benvenuti su ComicVault, il tuo punto di riferimento per i fumetti! Siamo un gruppo di appassionati che vive e respira storie a fumetti, impegnati a portarti il meglio del mondo dei comics, manga e graphic novels. La nostra missione è condividere con te la magia delle tavole disegnate, scoprire nuovi talenti e riscoprire i grandi classici. Che tu sia un veterano del genere o un nuovo lettore, qui troverai recensioni, anteprime esclusive e consigli personalizzati per ogni gusto. Unisciti a noi in questa avventura tra eroi, antieroi e mondi fantastici. Buona lettura!</p>
    ...
    <p>Le nostre spedizioni vengono effettuate da GLS Espresso al prezzo standard di 5,50€ e vengono consegnate in 24/48 ore lavorative, dal momento in cui ricevi l'avviso di consegna in corso.
        ...
        Per chi lo richiederà sarà possibile pagare con contrassegno con un sovrapprezzo di 5,00€.

        Nei periodi che seguono l'uscita di un prodotto molto richiesto, la lavorazione del tuo ordine in 24/48 ore lavorative potrebbe non essere garantita. Alcune spedizioni potrebbero infatti subire ritardi fino a 7 giorni lavorativi. Ogni volta che al tuo ordine accade qualcosa, riceverai un avviso via mail.

        Nel caso di indirizzo errato, non esistente, pacco rifiutato o cliente non presente alla consegna per 2 volte consecutive, la spedizione viene inviata in giacenza e può essere richiesta una terza consegna a carico del destinatario entro 7 giorni. Se non viene richiesta nessuna nuova consegna o la spedizione non viene ritirata dalla giacenza entro 7 giorni, l'ordine viene rispedito al mittente.

        Per maggiori informazioni sulle spedizioni o sui ritardi, mandare una email a servizioclienti@comicvault.it.</p>
</div>
